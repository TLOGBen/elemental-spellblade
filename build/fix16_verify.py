...
def verify_records():
 ...
 # Round 24 (N5): 安全閥 (1) reads the DLL's ESSB_N5_SafetyValve, put on you at the burst (checked by build/fix24_verify.py);
 # its Papyrus window keeps its record but no PERK uses it.
 owners={0:('common','順轉'),4:('divine','神佑')}
